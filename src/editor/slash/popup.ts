...
/**
 * Floating SlashMenu popup positioned at the caret, in the shape the
 * Suggestion plugin's `render` option expects. Shared by the slash command
 * and the citation autocomplete.
 */
